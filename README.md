...
O projeto consiste em um sistema de vendas de jogos, no qual há o cadastro de usuários, jogos e pedidos.
Existem dois tipos de usuário, sendo o administrador e o cliente. 
...
Kaysheen: Front-end
Lucas: Backend, parte do EJS e parte do Banco de Dados
Miguel: Autenticação e Segurança
Pedro: Banco de Dados e parte do Backend